...
export type ClientCommand = CmdSubscribe | CmdSendMessage | CmdInterrupt | CmdApprove | CmdAnswerApproval | CmdAnswerQuestion | CmdList | CmdRegisterDevice | CmdRevokeDevice;
